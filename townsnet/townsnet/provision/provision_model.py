...
class ProvisionModel():
    ...
    def __init__(self, towns_gdf : gpd.GeoDataFrame, acc_mx : pd.DataFrame, max_depth : int = 5, verbose : bool = True):
        ...
        self.provision_matrix = pd.DataFrame(0, index=towns_gdf.index, columns=towns_gdf.index, dtype=float)
    ...
    def calculate(
        ...
        return gdf, self.provision_matrix
    ...
    def _lp_provision(
        ...
        for var in prob.variables():
            ...
            if value > 0:
                self.provision_matrix.loc[a, b] += value
